namespace Seminar11_AccessBD
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.demo_bdaccessDataSet = new Seminar11_AccessBD.demo_bdaccessDataSet();
			this.produseBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.produseTableAdapter = new Seminar11_AccessBD.demo_bdaccessDataSetTableAdapters.ProduseTableAdapter();
			this.ds = new Seminar11_AccessBD.dataset_mdb();
			this.produseBindingSource1 = new System.Windows.Forms.BindingSource(this.components);
			this.produseTableAdapter1 = new Seminar11_AccessBD.dataset_mdbTableAdapters.ProduseTableAdapter();
			...
			((System.ComponentModel.ISupportInitialize)(this.demo_bdaccessDataSet)).BeginInit();
			...
			// 
			// demo_bdaccessDataSet
			// 
			this.demo_bdaccessDataSet.DataSetName = "demo_bdaccessDataSet";
			this.demo_bdaccessDataSet.SchemaSerializationMode = System.Data.SchemaSerializationMode.IncludeSchema;
			// 
			// produseBindingSource
			// 
			this.produseBindingSource.DataMember = "Produse";
			this.produseBindingSource.DataSource = this.demo_bdaccessDataSet;
			// 
			// produseTableAdapter
			// 
			...
			// textBox1
			// 
			this.textBox1.Location = new System.Drawing.Point(118, 300);
			...
			((System.ComponentModel.ISupportInitialize)(this.demo_bdaccessDataSet)).EndInit();
		...
		private demo_bdaccessDataSet demo_bdaccessDataSet;
		private System.Windows.Forms.BindingSource produseBindingSource;
		private demo_bdaccessDataSetTableAdapters.ProduseTableAdapter produseTableAdapter;
